...
int ColorWB(int port){
    delay(500);
    if (port == COLORSENOR1){
        gColorSF1[0] = 255.0 / colorCounter1[0];
        gColorSF1[1] = 255.0 / colorCounter1[1]; 
        gColorSF1[2] = 255.0 / colorCounter1[2]; 
        ...
        gColorSF2[0] = 255.0 / colorCounter2[0]; 
        gColorSF2[1] = 255.0 / colorCounter2[1]; 
        gColorSF2[2] = 255.0 / colorCounter2[2];
...
int ColorDeinit(int port)
{
    if (port == COLORSENOR1){
        ...
        digitalWrite(Color1_LED, LOW); 
        gCount1 = 0;
    }
    else if (port == COLORSENOR2){
        detachInterrupt(ITRNUM2);
        pinMode(Color2_LED, INPUT);
        digitalWrite(Color2_LED, LOW); 
        gCount2 = 0;
    }
